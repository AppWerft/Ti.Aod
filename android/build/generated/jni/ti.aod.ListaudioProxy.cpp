...
Persistent<FunctionTemplate> ListaudioProxy::proxyTemplate;
jclass ListaudioProxy::javaClass = NULL;

ListaudioProxy::ListaudioProxy() : titanium::Proxy()
{
}

void ListaudioProxy::bindProxy(Local<Object> exports, Local<Context> context)
{
	...
	Local<String> nameSymbol = NEW_SYMBOL(isolate, "Listaudio"); // use symbol over string for efficiency
	exports->Set(context, nameSymbol, constructor);
}

void ListaudioProxy::dispose(Isolate* isolate)
{
	LOGD(TAG, "dispose()");
...
Local<FunctionTemplate> ListaudioProxy::getProxyTemplate(v8::Isolate* isolate)
{
	...
	LOGD(TAG, "ListaudioProxy::getProxyTemplate()");

	javaClass = titanium::JNIUtil::findClass("ti/aod/ListaudioProxy");
	EscapableHandleScope scope(isolate);

	// use symbol over string for efficiency
	Local<String> nameSymbol = NEW_SYMBOL(isolate, "Listaudio");
...
Local<FunctionTemplate> ListaudioProxy::getProxyTemplate(v8::Local<v8::Context> context)
{
